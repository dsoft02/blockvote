                    ...
                    return (
                        <div key={election.id} className="bg-white rounded-xl shadow border">
                            ...
                            <div className="p-6 border-b">
                                <div
                                    className="flex flex-col md:flex-row md:items-center md:justify-between mb-2 space-y-3 md:space-y-0">
                                ...
                                {hasVotes && (
                                    <div className="flex items-center space-x-2 text-green-600 mt-1">
                                        ...
                                        <span
                                            className="font-medium">Leading: {candidates[0].name} ({((candidates[0].votes / totalVotes) * 100).toFixed(1)}%)</span>
                                    </div>
                                )}
                            </div>
